...
public class CustOrgTest {
	@Test
	public void createOrgTest() throws InterruptedException, Throwable
	{
		...
		//get the java representation object of the physical file
				...
				String PWSRD = System.getProperty("password");
                String organisation = System.getProperty("organisation");
