...
public class Test_case_2_Wth_industry_and_Type {
	...
	Select s1=new Select(dd1);
	 ...
	 String industry = s1.getFirstSelectedOption().getText();
	
	Select s2=new Select(dd2);
	s2.selectByVisibleText("Press");
	String type = s2.getFirstSelectedOption().getText();
	
	driver.findElement(By.xpath("(//input[@class='crmbutton small save'])[1]")).click();
	String Industry_Field = driver.findElement(By.xpath("//span[@id='dtlview_Industry']")).getText();
	
	
	String type_field = driver.findElement(By.xpath("//span[@id='dtlview_Email Opt Out']")).getText();
	
	
	if(Industry_Field.equals(industry))
	{
		System.out.println("Industry Field is verified");
	}
	else
	{
		System.out.println("Industry Field is not verified");
	}
	if(type_field.equals(type))
	{
		System.out.println("Type Field is verified");
	}
	else
	{
		System.out.println("Type Field is not verified");
	}
